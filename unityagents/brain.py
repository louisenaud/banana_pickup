...
class BrainParameters:
    def __init__(self, brain_name, brain_param):
        ...
        self.num_stacked_vector_observations = brain_param[
        ...
        self.vector_action_space_type = ["discrete", "continuous"][
            brain_param["vectorActionSpaceType"]
        ]
        self.vector_observation_space_type = ["discrete", "continuous"][
            brain_param["vectorObservationSpaceType"]
        ]
    ...
    def __str__(self):
        ...
        Vector Action descriptions: {7}""".format(
            self.brain_name,
